...
img_filenames = os.listdir('./picture/train')
 
for img_filename in img_filenames:
    if '.jpg' not in img_filename:
        continue
    img = load_img('./picture/train/{0}'.format(img_filename), color_mode='grayscale')
...
y_list=string_vectorizer(str)
#y_list = keras.utils.to_categorical(y_list)
